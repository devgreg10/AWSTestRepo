...
BEGIN
    ...
    retention AS (
        ...
        --this filter makes it such that the numerator and denominator only count participants who were teens last year
    ...
    SELECT
        ...
        (retention.retained_participants * 1.0) / NULLIF(retention.total_participants, 0) AS teen_retention_percentage
    FROM
        retention
    RIGHT JOIN
        (   
