...
CREATE TEMP TABLE temp_historical_female_percentage AS
SELECT
    *
...
DROP TABLE ft_ds_refined.metric_historical_female_percentage;
...
CREATE TABLE IF NOT EXISTS ft_ds_refined.metric_historical_female_percentage (
...
SELECT
    *
FROM temp_historical_female_percentage
;
