...
CREATE TEMP TABLE temp_historical_active_participant_counts AS
SELECT
    *
...
DROP TABLE ft_ds_refined.metric_historical_active_participant_counts;
...
SELECT
    *
FROM temp_historical_active_participant_counts
;
