...
from data_core.salesforce.badge.sf_badge_db_helper import SalesforceBadgeDbHelper
from data_core.salesforce.badge.sf_badge_db_models import SfBadgeSourceModel
...
def lambda_handler(event, context):
    ...
    function_name = "Load layer lambda for Salesforce Badge"
    ...
    try:
        ...
        try:
            ...
            logger.error(f"{function_name} - Error occurred loading S3 badges to Raw: {e}")
            if db_connection:
