...
class SalesforceContactDbHelper:
    ...
    def insert_sf_raw_contacts(*, 
        ...
        INSERT INTO ft_ds_raw.sf_contact (
            ...
            contact_type_text__c, military__c, contact_id__c, primary_contact_s_email__c, region__c, chapterid_contact__c, 
            accomplishment_level__c, additional_information__c, area_of_interest__c, attended_coach_advanced_training__c, birthdate_map__c, 
            branded_program_location__c, casesafeid__c, chapter_title__c, first_tee_employment_type__c, coach_fee_amount_paid__c, 
            coach_fee_paid_date__c, coach_inactive_date__c, coach_level__c, golf_level__c, inactive__c, legacy_id__c, school_city__c, 
            school_name__c, school_name_other__c, school_state__c, transitioned__c, player_coach_training__c, total_available_credits__c, 
            docebo_is_coach__c, request_advanced_training__c, participant_level_accomplishments__c, coach_membership_fee_due__c, 
            coach_membership_fee_paid__c, coach_program_start_date__c, coach_qualified_for__c, coach_retention_status_changed_date__c, 
            company__c, contact_type__c, curriculum_session_registration_date__c, custom_created_date__c, eligible_participants__c, 
            executive_director_email__c, general_availability_days_of_the_week__c, general_availability_seasons__c, golf_course_affiliation__c, 
            home_phone_map__c, hours_of_training_attended__c, how_did_you_hear_about_us__c, is_coach__c, lead_coach_total_hours__c, 
            age__c, allergies__c, contact_inactive_date__c, county__c, dietary_restrictions__c, disabilities__c, emergency_contact_email__c, 
            emergency_contact_name__c, emergency_contact_number__c, request_act_training__c, emergency_contact__c, ethnicity__c, 
            gender__c, lead_coach_total_sessions__c, lead_source_other__c, lifetime_member__c, listing__c, mailing_address_company__c, 
            main_program_location__c, master_coach_recognition_year__c, other_address_company__c, other_golf_certifications_description__c, 
            other_qualifications__c, participation_status__c, primary_contact_s_mobile_phone_provider__c, primary_contact_s_mobile__c, 
            primary_contact_s_name__c, program_director_primary_email__c, program_director_secondary_email__c, program_level__c, 
            progressed_participants__c, fmp_id__c, grade__c, historic_health_info__c, legacy_participant_user_id__c, mrm_id__c, 
            membership_created_date__c, membership_status__c, membership_valid_from__c, membership_valid_to__c, middle_name__c, 
            military_affiliation__c, military_base_installation__c, military_branch__c, mobile_phone_provider__c, nickname__c, 
            preferred_contact_method__c, reggie_id__c, reggie_participant_id__c, relationship_to_participants__c, secondary_email__c, 
            usga_handicap__c, work_phone__c, progression_status_changed_date__c, progression_status__c, reason_for_leaving__c, 
            recognized_the_first_tee_coach_year__c, retained_coach_count__c, retention_status__c, secondary_contact_s_email__c, 
            serve_as_national_trainer__c, served_as_one_day_observer__c, session_transfer_from__c, session_transfer_to__c, 
            status__c, support_coach_total_coaching_hours__c, support_coach_total_sessions__c, title__c, total_coaching_hours1__c, 
            total_coaching_hours__c, total_listing_sessions_delivered__c, total_sessions_coach_assigned__c, track_program_level__c, 
            participant_hours__c, parent_contact__c, litmos__access_level__c, litmos__completed_percentage__c, litmos__courses_assigned__c, 
            litmos__courses_completed__c, litmos__deactivate_from_litmos__c, litmos__full_name__c, litmos__languages__c, litmos__level__c, 
            litmos__litmosid__c, litmos__litmos_activated__c, litmos__litmos_login_access__c, litmos__litmos_userid__c, litmos__originalid__c, 
            litmos__sync_litmos__c, litmos__total_sum_percentages__c, litmos__user_id__c, litmos__p_completed_percentage__c, 
            executive_updates__c, safesport_compliance_not_required__c, student_notes__c, language__c, ft_app_pilot__c, 
            international_chapter__c, fyi__c, impact_today__c, press_clippings__c, market_size__c, territory__c, active_chapter__c, 
            combinationforkey__c, created_by_lead__c, sports_engine_id__c, cloudingo_related_account_type__c, mdr__c, merged_email__c, 
            mdr_nid__c, ethnicity_location__c, duplicates_removed__c, accountiddubmatch__c, birthdate_dupe_match__c, 
            background_check_exp_bucket__c, background_check_expiration_date__c, background_check_passed__c, background_check_status__c, 
            compliant__c, days_until_background_check_expires__c, days_until_safesport_training_expires__c, number_of_safety_records__c, 
            safesport_training_completed__c, safesport_training_exp_bucket__c, safesport_training_expiration_date__c, safesport_training_status__c, 
            contact_name__c, training_type__c, chapter_safe_sport_designation__c, docebo_email__c, docebo_user_id__c, 
            docebo_is_community_staff__c, docebo_is_parent__c, docebo_is_participant__c, docebo_is_school_staff__c, 
            docebo_username_override__c, docebo_username__c, salesforce_username__c, docebo_pilot_user__c, docebo_is_hq_staff__c, 
            docebo_disconnect__c, docebo_account_active__c, master_coach__c, primary_contact_home_phone__c, user_email__c, 
            impact_today_board_members__c, impact_today_coaches__c, impact_today_leaders__c, nccp__c, pursuing_ace__c, 
            docebo_is_junior_coach__c, lifetime_gamification_points__c, respect_in_sport_certification__c, canva_admin__c, 
            website_admin__c, docebo_username_randomly_generated__c, dss_ingestion_timestamp
        )
        VALUES (
            ...
            %(chapter_affiliation__c)s, %(chapterid__c)s, %(override__c)s, %(active__c)s, %(ownerid__c)s, %(trigger_time__c)s,
            %(contact_type_text__c)s, %(military__c)s, %(contact_id__c)s, %(primary_contact_s_email__c)s, %(region__c)s,
            %(chapterid_contact__c)s, %(accomplishment_level__c)s, %(additional_information__c)s, %(area_of_interest__c)s,
            %(attended_coach_advanced_training__c)s, %(birthdate_map__c)s, %(branded_program_location__c)s, %(casesafeid__c)s,
            %(chapter_title__c)s, %(first_tee_employment_type__c)s, %(coach_fee_amount_paid__c)s, %(coach_fee_paid_date__c)s,
            %(coach_inactive_date__c)s, %(coach_level__c)s, %(golf_level__c)s, %(inactive__c)s, %(legacy_id__c)s, %(school_city__c)s,
            %(school_name__c)s, %(school_name_other__c)s, %(school_state__c)s, %(transitioned__c)s, %(player_coach_training__c)s,
            %(total_available_credits__c)s, %(docebo_is_coach__c)s, %(request_advanced_training__c)s, %(participant_level_accomplishments__c)s,
            %(coach_membership_fee_due__c)s, %(coach_membership_fee_paid__c)s, %(coach_program_start_date__c)s, %(coach_qualified_for__c)s,
            %(coach_retention_status_changed_date__c)s, %(company__c)s, %(contact_type__c)s, %(curriculum_session_registration_date__c)s,
            %(custom_created_date__c)s, %(eligible_participants__c)s, %(executive_director_email__c)s, %(general_availability_days_of_the_week__c)s,
            %(general_availability_seasons__c)s, %(golf_course_affiliation__c)s, %(home_phone_map__c)s, %(hours_of_training_attended__c)s,
            %(how_did_you_hear_about_us__c)s, %(is_coach__c)s, %(lead_coach_total_hours__c)s, %(age__c)s, %(allergies__c)s,
            %(contact_inactive_date__c)s, %(county__c)s, %(dietary_restrictions__c)s, %(disabilities__c)s, %(emergency_contact_email__c)s,
            %(emergency_contact_name__c)s, %(emergency_contact_number__c)s, %(request_act_training__c)s, %(emergency_contact__c)s,
            %(ethnicity__c)s, %(gender__c)s, %(lead_coach_total_sessions__c)s, %(lead_source_other__c)s, %(lifetime_member__c)s, 
            %(listing__c)s, %(mailing_address_company__c)s, %(main_program_location__c)s, %(master_coach_recognition_year__c)s,
            %(other_address_company__c)s, %(other_golf_certifications_description__c)s, %(other_qualifications__c)s,
            %(participation_status__c)s, %(primary_contact_s_mobile_phone_provider__c)s, %(primary_contact_s_mobile__c)s,
            %(primary_contact_s_name__c)s, %(program_director_primary_email__c)s, %(program_director_secondary_email__c)s,
            %(program_level__c)s, %(progressed_participants__c)s, %(fmp_id__c)s, %(grade__c)s, %(historic_health_info__c)s,
            %(legacy_participant_user_id__c)s, %(mrm_id__c)s, %(membership_created_date__c)s, %(membership_status__c)s,
            %(membership_valid_from__c)s, %(membership_valid_to__c)s, %(middle_name__c)s, %(military_affiliation__c)s,
            %(military_base_installation__c)s, %(military_branch__c)s, %(mobile_phone_provider__c)s, %(nickname__c)s,
            %(preferred_contact_method__c)s, %(reggie_id__c)s, %(reggie_participant_id__c)s, %(relationship_to_participants__c)s,
            %(secondary_email__c)s, %(usga_handicap__c)s, %(work_phone__c)s, %(progression_status_changed_date__c)s,
            %(progression_status__c)s, %(reason_for_leaving__c)s, %(recognized_the_first_tee_coach_year__c)s,
            %(retained_coach_count__c)s, %(retention_status__c)s, %(secondary_contact_s_email__c)s, %(serve_as_national_trainer__c)s,
            %(served_as_one_day_observer__c)s, %(session_transfer_from__c)s, %(session_transfer_to__c)s, %(status__c)s,
            %(support_coach_total_coaching_hours__c)s, %(support_coach_total_sessions__c)s, %(title__c)s, %(total_coaching_hours1__c)s,
            %(total_coaching_hours__c)s, %(total_listing_sessions_delivered__c)s, %(total_sessions_coach_assigned__c)s,
            %(track_program_level__c)s, %(participant_hours__c)s, %(parent_contact__c)s, %(litmos__access_level__c)s,
            %(litmos__completed_percentage__c)s, %(litmos__courses_assigned__c)s, %(litmos__courses_completed__c)s,
            %(litmos__deactivate_from_litmos__c)s, %(litmos__full_name__c)s, %(litmos__languages__c)s, %(litmos__level__c)s,
            %(litmos__litmosid__c)s, %(litmos__litmos_activated__c)s, %(litmos__litmos_login_access__c)s, %(litmos__litmos_userid__c)s,
            %(litmos__originalid__c)s, %(litmos__sync_litmos__c)s, %(litmos__total_sum_percentages__c)s, %(litmos__user_id__c)s,
            %(litmos__p_completed_percentage__c)s, %(executive_updates__c)s, %(safesport_compliance_not_required__c)s,
            %(student_notes__c)s, %(language__c)s, %(ft_app_pilot__c)s, %(international_chapter__c)s, %(fyi__c)s,
            %(impact_today__c)s, %(press_clippings__c)s, %(market_size__c)s, %(territory__c)s, %(active_chapter__c)s,
            %(combinationforkey__c)s, %(created_by_lead__c)s, %(sports_engine_id__c)s, %(cloudingo_related_account_type__c)s,
            %(mdr__c)s, %(merged_email__c)s, %(mdr_nid__c)s, %(ethnicity_location__c)s, %(duplicates_removed__c)s,
            %(accountiddubmatch__c)s, %(birthdate_dupe_match__c)s, %(background_check_exp_bucket__c)s, %(background_check_expiration_date__c)s,
            %(background_check_passed__c)s, %(background_check_status__c)s, %(compliant__c)s, %(days_until_background_check_expires__c)s,
            %(days_until_safesport_training_expires__c)s, %(number_of_safety_records__c)s, %(safesport_training_completed__c)s,
            %(safesport_training_exp_bucket__c)s, %(safesport_training_expiration_date__c)s, %(safesport_training_status__c)s,
            %(contact_name__c)s, %(training_type__c)s, %(chapter_safe_sport_designation__c)s, %(docebo_email__c)s, %(docebo_user_id__c)s,
            %(docebo_is_community_staff__c)s, %(docebo_is_parent__c)s, %(docebo_is_participant__c)s, %(docebo_is_school_staff__c)s,
            %(docebo_username_override__c)s, %(docebo_username__c)s, %(salesforce_username__c)s, %(docebo_pilot_user__c)s,
            %(docebo_is_hq_staff__c)s, %(docebo_disconnect__c)s, %(docebo_account_active__c)s, %(master_coach__c)s,
            %(primary_contact_home_phone__c)s, %(user_email__c)s, %(impact_today_board_members__c)s, %(impact_today_coaches__c)s,
            %(impact_today_leaders__c)s, %(nccp__c)s, %(pursuing_ace__c)s, %(docebo_is_junior_coach__c)s, %(lifetime_gamification_points__c)s,
            %(respect_in_sport_certification__c)s, %(canva_admin__c)s, %(website_admin__c)s, %(docebo_username_randomly_generated__c)s,
        ...
        DO UPDATE SET
            ...
            override__c = EXCLUDED.override__c,
            ...
            accomplishment_level__c = EXCLUDED.accomplishment_level__c,
            additional_information__c = EXCLUDED.additional_information__c,
            ...
            birthdate_map__c = EXCLUDED.birthdate_map__c,
            ...
            golf_level__c = EXCLUDED.golf_level__c,
            ...
            executive_director_email__c = EXCLUDED.executive_director_email__c,
            ...
            home_phone_map__c = EXCLUDED.home_phone_map__c,
            hours_of_training_attended__c = EXCLUDED.hours_of_training_attended__c,
            ...
            emergency_contact__c = EXCLUDED.emergency_contact__c,
            ...
            lifetime_member__c = EXCLUDED.lifetime_member__c,
            ...
            other_address_company__c = EXCLUDED.other_address_company__c,
            other_golf_certifications_description__c = EXCLUDED.other_golf_certifications_description__c,
            other_qualifications__c = EXCLUDED.other_qualifications__c,
            ...
            program_director_primary_email__c = EXCLUDED.program_director_primary_email__c,
            program_director_secondary_email__c = EXCLUDED.program_director_secondary_email__c,
            ...
            historic_health_info__c = EXCLUDED.historic_health_info__c,
            ...
            middle_name__c = EXCLUDED.middle_name__c,
            military_affiliation__c = EXCLUDED.military_affiliation__c,
            military_base_installation__c = EXCLUDED.military_base_installation__c,
            military_branch__c = EXCLUDED.military_branch__c,
            ...
            usga_handicap__c = EXCLUDED.usga_handicap__c,
            ...
            session_transfer_from__c = EXCLUDED.session_transfer_from__c,
            session_transfer_to__c = EXCLUDED.session_transfer_to__c,
            ...
            total_coaching_hours__c = EXCLUDED.total_coaching_hours__c,
            ...
            track_program_level__c = EXCLUDED.track_program_level__c,
            participant_hours__c = EXCLUDED.participant_hours__c,
            parent_contact__c = EXCLUDED.parent_contact__c,
            litmos__access_level__c = EXCLUDED.litmos__access_level__c,
            litmos__completed_percentage__c = EXCLUDED.litmos__completed_percentage__c,
            litmos__courses_assigned__c = EXCLUDED.litmos__courses_assigned__c,
            litmos__courses_completed__c = EXCLUDED.litmos__courses_completed__c,
            litmos__deactivate_from_litmos__c = EXCLUDED.litmos__deactivate_from_litmos__c,
            litmos__full_name__c = EXCLUDED.litmos__full_name__c,
            litmos__languages__c = EXCLUDED.litmos__languages__c,
            litmos__level__c = EXCLUDED.litmos__level__c,
            litmos__litmosid__c = EXCLUDED.litmos__litmosid__c,
            litmos__litmos_activated__c = EXCLUDED.litmos__litmos_activated__c,
            litmos__litmos_login_access__c = EXCLUDED.litmos__litmos_login_access__c,
            litmos__litmos_userid__c = EXCLUDED.litmos__litmos_userid__c,
            litmos__originalid__c = EXCLUDED.litmos__originalid__c,
            litmos__sync_litmos__c = EXCLUDED.litmos__sync_litmos__c,
            litmos__total_sum_percentages__c = EXCLUDED.litmos__total_sum_percentages__c,
            litmos__user_id__c = EXCLUDED.litmos__user_id__c,
            litmos__p_completed_percentage__c = EXCLUDED.litmos__p_completed_percentage__c,
            executive_updates__c = EXCLUDED.executive_updates__c,
            ...
            combinationforkey__c = EXCLUDED.combinationforkey__c,
            created_by_lead__c = EXCLUDED.created_by_lead__c,
            sports_engine_id__c = EXCLUDED.sports_engine_id__c,
            cloudingo_related_account_type__c = EXCLUDED.cloudingo_related_account_type__c,
            ...
            accountiddubmatch__c = EXCLUDED.accountiddubmatch__c,
            birthdate_dupe_match__c = EXCLUDED.birthdate_dupe_match__c,
            ...
            user_email__c = EXCLUDED.user_email__c,
            ...
            canva_admin__c = EXCLUDED.canva_admin__c,
            website_admin__c = EXCLUDED.website_admin__c,
        ...
        records = [
            {
                ...
                "override__c": contact.override__c,
                "active__c": contact.active__c,
                "ownerid__c": contact.ownerid__c,
                "trigger_time__c": contact.trigger_time__c,
                ...
                "chapterid_contact__c": contact.chapterid_contact__c,
                "accomplishment_level__c": contact.accomplishment_level__c,
                "additional_information__c": contact.additional_information__c,
                ...
                "birthdate_map__c": contact.birthdate_map__c,
                ...
                "golf_level__c": contact.golf_level__c,
                ...
                "executive_director_email__c": contact.executive_director_email__c,
                ...
                "home_phone_map__c": contact.home_phone_map__c,
                "hours_of_training_attended__c": contact.hours_of_training_attended__c,
                ...
                "emergency_contact__c": contact.emergency_contact__c,
                ...
                "lifetime_member__c": contact.lifetime_member__c,
                ...
                "other_address_company__c": contact.other_address_company__c,
                "other_golf_certifications_description__c": contact.other_golf_certifications_description__c,
                "other_qualifications__c": contact.other_qualifications__c,
                ...
                "program_director_primary_email__c": contact.program_director_primary_email__c,
                "program_director_secondary_email__c": contact.program_director_secondary_email__c,
                ...
                "historic_health_info__c": contact.historic_health_info__c,
                ...
                "military_affiliation__c": contact.military_affiliation__c,
                "military_base_installation__c": contact.military_base_installation__c,
                "military_branch__c": contact.military_branch__c,
                ...
                "usga_handicap__c": contact.usga_handicap__c,
                ...
                "session_transfer_from__c": contact.session_transfer_from__c,
                "session_transfer_to__c": contact.session_transfer_to__c,
                ...
                "total_coaching_hours__c": contact.total_coaching_hours__c,
                ...
                "track_program_level__c": contact.track_program_level__c,
                "participant_hours__c": contact.participant_hours__c,
                "parent_contact__c": contact.parent_contact__c,
                "litmos__access_level__c": contact.litmos__access_level__c,
                "litmos__completed_percentage__c": contact.litmos__completed_percentage__c,
                "litmos__courses_assigned__c": contact.litmos__courses_assigned__c,
                "litmos__courses_completed__c": contact.litmos__courses_completed__c,
                "litmos__deactivate_from_litmos__c": contact.litmos__deactivate_from_litmos__c,
                "litmos__full_name__c": contact.litmos__full_name__c,
                "litmos__languages__c": contact.litmos__languages__c,
                "litmos__level__c": contact.litmos__level__c,
                "litmos__litmosid__c": contact.litmos__litmosid__c,
                "litmos__litmos_activated__c": contact.litmos__litmos_activated__c,
                "litmos__litmos_login_access__c": contact.litmos__litmos_login_access__c,
                "litmos__litmos_userid__c": contact.litmos__litmos_userid__c,
                "litmos__originalid__c": contact.litmos__originalid__c,
                "litmos__sync_litmos__c": contact.litmos__sync_litmos__c,
                "litmos__total_sum_percentages__c": contact.litmos__total_sum_percentages__c,
                "litmos__user_id__c": contact.litmos__user_id__c,
                "litmos__p_completed_percentage__c": contact.litmos__p_completed_percentage__c,
                "executive_updates__c": contact.executive_updates__c,
                ...
                "combinationforkey__c": contact.combinationforkey__c,
                "created_by_lead__c": contact.created_by_lead__c,
                "sports_engine_id__c": contact.sports_engine_id__c,
                "cloudingo_related_account_type__c": contact.cloudingo_related_account_type__c,
                ...
                "duplicates_removed__c": contact.duplicates_removed__c,
                "accountiddubmatch__c": contact.accountiddubmatch__c,
                "birthdate_dupe_match__c": contact.birthdate_dupe_match__c,
                ...
                "user_email__c": contact.user_email__c,
                ...
                "canva_admin__c": contact.canva_admin__c,
                "website_admin__c": contact.website_admin__c,
