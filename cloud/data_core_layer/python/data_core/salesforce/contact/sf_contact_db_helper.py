    ...
    def insert_sf_raw_contacts(*, 
        ...
        upsert_query = """
            ...
            (
                ...
                %(region__c)s,
                %(chapterid_contact__c)s,
                %(accomplishment_level__c)s,
                ...
                %(program_director_primary_email__c)s,
                %(program_director_secondary_email__c)s,
                %(program_level__c)s,
                %(progressed_participants__c)s,
                %(fmp_id__c)s,
                %(grade__c)s,
                %(historic_health_info__c)s,
                ...
                %(middle_name__c)s,
                %(military_affiliation__c)s,
                %(military_base_installation__c)s,
                %(military_branch__c)s,
                ...
                %(session_transfer_from__c)s,
                %(session_transfer_to__c)s,
                %(status__c)s,
                %(support_coach_total_coaching_hours__c)s,
                %(support_coach_total_sessions__c)s,
                %(title__c)s,
                %(total_coaching_hours1__c)s,
                %(total_coaching_hours__c)s,
                %(total_listing_sessions_delivered__c)s,
                %(total_sessions_coach_assigned__c)s,
                %(track_program_level__c)s,
                %(participant_hours__c)s,
                %(parent_contact__c)s,
                %(litmos__access_level__c)s,
                %(litmos__completed_percentage__c)s,
                %(litmos__courses_assigned__c)s,
                %(litmos__courses_completed__c)s,
                %(litmos__deactivate_from_litmos__c)s,
                %(litmos__full_name__c)s,
                %(litmos__languages__c)s,
                %(litmos__level__c)s,
                %(litmos__litmosid__c)s,
                %(litmos__litmos_activated__c)s,
                %(litmos__litmos_login_access__c)s,
                %(litmos__litmos_userid__c)s,
                %(litmos__originalid__c)s,
                %(litmos__sync_litmos__c)s,
                %(litmos__total_sum_percentages__c)s,
                %(litmos__user_id__c)s,
                %(litmos__p_completed_percentage__c)s,
                %(executive_updates__c)s,
                ...
                %(territory__c)s,
                %(active_chapter__c)s,
                %(combinationforkey__c)s,
                %(created_by_lead__c)s,
                %(sports_engine_id__c)s,
                %(cloudingo_related_account_type__c)s,
                %(mdr__c)s,
                %(merged_email__c)s,
                %(mdr_nid__c)s,
                %(ethnicity_location__c)s,
                %(duplicates_removed__c)s,
                %(accountiddubmatch__c)s,
                %(birthdate_dupe_match__c)s,
        ...
        records = [
            {
                ...
                "masterrecordid": contact.masterrecordid,
