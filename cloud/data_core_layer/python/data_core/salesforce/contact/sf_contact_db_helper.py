...
class SalesforceContactDbHelper:
    ...
    def insert_sf_raw_contacts(*, 
        ...
        INSERT INTO ft_ds_raw.sf_contact (
            ...
            hours_of_training_attended__c, how_did_you_hear_about_us__c, is_coach__c, lead_coach_total_hours__c, 
        ...
        VALUES (
            ...
            %(general_availability_seasons__c)s, %(golf_course_affiliation__c)s, %(hours_of_training_attended__c)s,
